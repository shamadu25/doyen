    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center gap-3">
                ...
                <h2 class="text-xl font-semibold leading-tight text-gray-800">New Customer</h2>
            </div>
        </template>
            ...
            <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="flex items-center justify-end gap-3">
                        <Link :href="route('/customers')" class="rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 transition">
                            Cancel
                        </Link>
                        <button
                            type="submit"
