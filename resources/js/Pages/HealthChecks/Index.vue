                ...
                <table class="w-full text-sm">
                    <thead class="bg-gray-50 border-b border-gray-200">
                        <tr>
                            ...
                            <th class="text-right px-4 py-3 font-medium text-gray-600">Mileage</th>
                            <th class="text-center px-4 py-3 font-medium text-gray-600">Good</th>
                            <th class="text-center px-4 py-3 font-medium text-gray-600">Advisory</th>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr v-for="c in checks.data" :key="c.id" class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 font-medium text-gray-900">{{ c.vehicle?.registration_number }}</td>
                            <td class="px-4 py-3 text-gray-600">{{ c.vehicle?.customer?.name }}</td>
                            <td class="px-4 py-3 text-right text-gray-600">{{ c.mileage?.toLocaleString() }}</td>
                            ...
                            <td class="px-4 py-3 text-center"><span class="px-2 py-0.5 bg-yellow-50 text-yellow-700 rounded-full text-xs font-medium">{{ c.advisory_count || 0 }}</span></td>
