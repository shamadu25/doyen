...
@section('content')
    ...
    <p>
        ...
        Please review the details online and approve the quote if you are happy to proceed. You can also download it or request an amendment from the quote page.
    </p>
    ...
    <div style="text-align:center;margin:30px 0;">
        ...
        <p style="color:#374151;margin-bottom:15px;">To review and approve your quote online, click the button below:</p>
