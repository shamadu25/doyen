        ...
        <div class="form-body">
            ...
            <div class="form-section">
                ...
                <div class="form-grid-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name') }}" required placeholder="e.g. Full Service">
                        @error('name') <span class="error-msg">{{ $message }}</span> @enderror
                    </div>
                    <div class="form-group">
                        <label for="code">Service Code</label>
                        <input type="text" name="code" id="code" value="{{ old('code') }}" placeholder="AUTO-GENERATED if blank">
                ...
                <div class="form-grid-2" style="margin-top:16px;">
                    <div class="form-group">
                        ...
                        <input type="text" name="category" id="category" list="category-list"
                               value="{{ old('category') }}" required placeholder="e.g. MOT, Service, Repair">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="icon" id="icon" value="{{ old('icon') }}" placeholder="e.g. 🔧 or fa-wrench">
                        <span class="hint">Emoji or icon class for display on website.</span>
                    </div>
                </div>
                <div class="form-group" style="margin-top:16px;">
                    <label for="description">Internal Description</label>
                    <textarea name="description" id="description" placeholder="Internal notes about this service…">{{ old('description') }}</textarea>
                </div>
                <div class="form-group" style="margin-top:16px;">
                    <label for="website_description">Website Description</label>
                    <textarea name="website_description" id="website_description"
                              placeholder="Description shown to customers on the website…">{{ old('website_description') }}</textarea>
                ...
                <div class="form-grid-3">
                    <div class="form-group">
                        ...
                        <input type="number" name="default_price" id="default_price"
                               value="{{ old('default_price', '0.00') }}" min="0" step="0.01" required>
                        @error('default_price') <span class="error-msg">{{ $message }}</span> @enderror
                    </div>
                    <div class="form-group">
                        <label for="cost_price">Cost Price (£)</label>
                        <input type="number" name="cost_price" id="cost_price"
                               value="{{ old('cost_price', '0.00') }}" min="0" step="0.01">
                    </div>
                    <div class="form-group">
                        <label for="vat_rate">VAT Rate (%)</label>
                        <input type="number" name="vat_rate" id="vat_rate"
                               value="{{ old('vat_rate', '20.00') }}" min="0" max="100" step="0.01">
                    </div>
                    <div class="form-group">
                        ...
                        <input type="number" name="estimated_duration_minutes" id="estimated_duration_minutes"
                               value="{{ old('estimated_duration_minutes', '60') }}" min="0" step="15">
                    </div>
                    <div class="form-group">
            ...
            <div class="form-section">
                ...
                <div class="toggle-row">
                    ...
                    <div class="toggle-group">
                        <input type="checkbox" name="requires_booking" id="requires_booking" value="1" {{ old('requires_booking', '1') ? 'checked' : '' }}>
                        <div>
                    ...
                    <div class="toggle-group">
                        <input type="checkbox" name="show_on_website" id="show_on_website" value="1" {{ old('show_on_website') ? 'checked' : '' }}>
                        <div>
