...
class ServiceSeeder extends Seeder
{
    ...
    {
        // Clear all existing services and re-seed from scratch
        ...
        $services = [
            ...
            ['name' => 'Custom Tuning Solution',        'code' => 'REMAP-CUST',     'category' => 'ECU Remapping & Performance Tuning','icon' => '⚡','description' => 'Bespoke tuning solution — contact us to discuss your requirements.', 'default_price' => 0.00,  'vat_rate' => 20.00, 'estimated_duration_minutes' => 0, 'sort_order' => 5],
        ...
        foreach ($services as $item) {
            Service::create(array_merge($item, [
                'is_active'       => true,
                'is_approved'     => true,
        ...
        $this->command->info('✓ Seeded ' . count($services) . ' services across 9 categories.');
    }
}
