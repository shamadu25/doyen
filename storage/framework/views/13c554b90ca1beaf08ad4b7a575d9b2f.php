...
<head>
    ...
    <title>Quote Review — <?php echo e(config('app.garage_name', 'Doyen Auto Services')); ?></title>
    <style>
...
<body>
<div class="header">
    <h1><?php echo e(config('app.garage_name', 'Doyen Auto Services')); ?></h1>
...
<div class="container">
    ...
    <?php if($quote->status === 'expired'): ?>
        <div class="alert alert-warning">
            ⏰ <strong>This quote has expired.</strong> The validity period ended on <?php echo e($quote->valid_until->format('F j, Y')); ?>.
    ...
    <div class="card">
        <div class="card-header">
            <h2>Quote <?php echo e($quote->quote_number); ?></h2>
        ...
        <div class="card-body">
            <div class="info-grid">
                <div class="info-item">
                    ...
                    <span><?php echo e($quote->customer->full_name); ?></span>
                </div>
                <?php if($quote->vehicle): ?>
                <div class="info-item">
                    <label>Vehicle</label>
                    <span><?php echo e($quote->vehicle->registration_number); ?> — <?php echo e($quote->vehicle->make); ?> <?php echo e($quote->vehicle->model); ?></span>
                </div>
                <?php endif; ?>
                <div class="info-item">
                    <label>Quote Date</label>
                    <span><?php echo e($quote->quote_date->format('F j, Y')); ?></span>
                </div>
                <div class="info-item">
                    <label>Valid Until</label>
                    <span class="<?php echo \Illuminate\Support\Arr::toCssClasses(['text-red-600' => $quote->isExpired()]); ?>">
                        <?php echo e($quote->valid_until->format('F j, Y')); ?>

                        <?php if($quote->isExpired()): ?> <em style="color:#dc2626;">(expired)</em> <?php endif; ?>
                    </span>
                </div>
                <?php if($quote->appointment): ?>
                <div class="info-item">
                    <label>Booking Reference</label>
                    <span><?php echo e($quote->appointment->reference_number); ?></span>
                </div>
                <div class="info-item">
                    <label>Requested Date</label>
                    <span><?php echo e(\Carbon\Carbon::parse($quote->appointment->scheduled_date)->format('l, F j, Y \a\t g:i A')); ?></span>
                </div>
                <?php endif; ?>
                <?php if($quote->description): ?>
                <div class="info-item" style="grid-column:1/-1">
                    <label>Work Description</label>
                    <span><?php echo e($quote->description); ?></span>
                </div>
                <?php endif; ?>
            </div>
        </div>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th>Qty</th>
                        <th>Unit Price</th>
                        <th>VAT (<?php echo e($quote->vat_rate); ?>%)</th>
                        <th>Total</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div class="item-type"><?php echo e($item->item_type); ?></div>
                            <?php echo e($item->description); ?>

                        </td>
                        <td><?php echo e($item->quantity); ?></td>
                        <td>£<?php echo e(number_format($item->unit_price, 2)); ?></td>
                        <td>£<?php echo e(number_format($item->total_price * ($quote->vat_rate / 100), 2)); ?></td>
                ...
                <tfoot>
                    ...
                    <tr>
                        ...
                        <td>£<?php echo e(number_format($quote->subtotal, 2)); ?></td>
                    </tr>
                    <tr>
                        <td colspan="4" style="text-align:right;color:#dc2626;">Discount (<?php echo e($quote->discount_percentage); ?>%)</td>
                        <td style="color:#dc2626;">−£<?php echo e(number_format($quote->discount_amount, 2)); ?></td>
                    </tr>
                    <?php endif; ?>
                    <tr>
                        <td colspan="4" style="text-align:right;color:#64748b;">VAT (<?php echo e($quote->vat_rate); ?>%)</td>
                        <td>£<?php echo e(number_format($quote->vat_amount, 2)); ?></td>
                    </tr>
                    <tr class="total-row">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="notes-box"><?php echo e($quote->notes); ?></div>
        </div>
    </div>
    <?php endif; ?>

    
    <?php if($quote->status === 'sent' && !$quote->isExpired()): ?>
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="actions">
                ...
                <form method="POST" action="<?php echo e(route('quote.approve', $token)); ?>" style="flex:1;">
                    <?php echo csrf_field(); ?>
            ...
            <div class="collapsible-form" id="suggestForm">
                ...
                <form method="POST" action="<?php echo e(route('quote.suggest-date', $token)); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="date" id="suggested_date" name="suggested_date"
                                   ...
                                   max="<?php echo e(now()->addDays(90)->format('Y-m-d')); ?>"
                                   required>
                        </div>
                        <div class="form-group">
            ...
            <div class="collapsible-form" id="declineForm">
                ...
                <form method="POST" action="<?php echo e(route('quote.decline', $token)); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="form-group">
            ...
            <p style="font-size:12px;color:#94a3b8;margin-top:16px;text-align:center;">
                This quote is valid until <strong><?php echo e($quote->valid_until->format('F j, Y')); ?></strong>.
    ...
    <div class="footer">
        <p><?php echo e(config('app.garage_name', 'Doyen Auto Services')); ?></p>
...
<?php /**PATH C:\xampp\htdocs\doyen\doyen\resources\views\quotes\public-review.blade.php ENDPATH**/ ?>