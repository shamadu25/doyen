...
<?php $__env->startSection('content'); ?>
    ...
    <div class="alert alert-warning">
        ...
        • Our address: <?php echo e(\App\Models\Setting::get('address', '59 Southcroft Road')); ?>, <?php echo e(\App\Models\Setting::get('city', 'Rutherglen, Glasgow')); ?>, <?php echo e(\App\Models\Setting::get('postcode', 'G73 1UG')); ?><br>
        • Parking available on site
    </div>

    <div style="text-align: center;">
        <a href="https://maps.google.com/?q=<?php echo e(urlencode(\App\Models\Setting::get('address', '59 Southcroft Road') . ' ' . \App\Models\Setting::get('city', 'Rutherglen Glasgow') . ' ' . \App\Models\Setting::get('postcode', 'G73 1SP'))); ?>" class="button">Get Directions</a>
    </div>

    <p style="margin-top: 30px; color: #64748b; font-size: 14px;">
        <strong>Need to reschedule?</strong><br>
        Please call us as soon as possible at <a href="tel:<?php echo e(preg_replace('/[^0-9+]/', '', \App\Models\Setting::get('phone', '+44 141 482 0726'))); ?>" style="color: #3b82f6;"><?php echo e(\App\Models\Setting::get('phone', '+44 141 482 0726')); ?></a>
    </p>
