...
<div class="show-card">
    <div class="show-header">
        <div>
            <h2><?php echo e($service->icon ? $service->icon . ' ' : ''); ?><?php echo e($service->name); ?></h2>
            <span style="background:#e8ecff;color:#3d56c9;padding:3px 10px;border-radius:12px;font-size:0.8rem;font-weight:600;">
                <?php echo e(ucwords($service->category ?? '—')); ?>

            </span>
            <?php if($service->code): ?>
            <span style="margin-left:8px;color:#999;font-size:0.82rem;"><?php echo e($service->code); ?></span>
            <?php endif; ?>
        </div>
        <div style="display:flex;gap:8px;flex-wrap:wrap;">
            ...
            <?php else: ?> <span class="badge" style="background:#eee;color:#666;">Hidden from Website</span>
            <?php endif; ?>
        </div>
    </div>
    <div class="show-body">
        <div class="info-grid">
            <div class="info-item">
                ...
                <span class="ival" style="font-size:1.3rem;color:#28a745;font-weight:700;">£<?php echo e(number_format($service->default_price, 2)); ?></span>
            </div>
            <div class="info-item">
                <span class="ilabel">VAT Rate</span>
                <span class="ival"><?php echo e($service->vat_rate); ?>%</span>
            </div>
            <div class="info-item">
                <span class="ilabel">Cost Price</span>
                <span class="ival">£<?php echo e(number_format($service->cost_price ?? 0, 2)); ?></span>
            </div>
            <div class="info-item">
                <span class="ilabel">Duration</span>
                <span class="ival"><?php echo e($service->estimated_duration_minutes ? $service->estimated_duration_minutes . ' minutes' : '—'); ?></span>
            </div>
            <div class="info-item">
                <span class="ilabel">Requires Booking</span>
                <span class="ival"><?php echo e($service->requires_booking ? 'Yes' : 'No'); ?></span>
            </div>
            <div class="info-item">
                <span class="ilabel">Sort Order</span>
                <span class="ival"><?php echo e($service->sort_order ?? 0); ?></span>
            </div>
        </div>
        ...
        <div class="info-item">
            ...
            <p style="color:#555;font-size:0.9rem;margin-top:6px;line-height:1.6;"><?php echo e($service->description); ?></p>
        </div>
        <?php endif; ?>

        <?php if($service->website_description): ?>
        <hr class="section-divider">
        <div class="info-item">
            <span class="ilabel">Website Description</span>
            <p style="color:#555;font-size:0.9rem;margin-top:6px;line-height:1.6;"><?php echo e($service->website_description); ?></p>
        </div>
        <?php endif; ?>
    </div>

    <div class="show-actions">
        <a href="<?php echo e(route('services.edit', $service)); ?>" class="btn btn-primary">✏️ Edit Service</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\doyen\doyen\resources\views\admin\services\show.blade.php ENDPATH**/ ?>