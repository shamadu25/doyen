...
<div class="form-card">
    <div class="form-card-header">
        <h2>✏️ Edit: <?php echo e($service->name); ?></h2>
        <div class="status-badges">
            <?php if($service->is_active): ?> <span class="badge badge-success">Active</span>
            <?php else: ?> <span class="badge badge-danger">Inactive</span> <?php endif; ?>
            <?php if($service->is_approved): ?> <span class="badge badge-info">Approved</span>
            <?php else: ?> <span class="badge badge-warning">Pending</span> <?php endif; ?>
            <?php if($service->show_on_website && $service->is_approved && $service->is_active): ?>
            <span class="badge badge-orange">🌐 Live</span> <?php endif; ?>
        </div>
    </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="code" id="code" value="<?php echo e(old('code', $service->code)); ?>">
                ...
                <div class="form-grid-2" style="margin-top:16px;">
                    <div class="form-group">
                        ...
                        <input type="text" name="category" id="category" list="category-list"
                               value="<?php echo e(old('category', $service->category)); ?>" required>
                        <datalist id="category-list">
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <option value="<?php echo e($cat); ?>"> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="icon" id="icon" value="<?php echo e(old('icon', $service->icon)); ?>" placeholder="e.g. 🔧">
                    </div>
                </div>
                <div class="form-group" style="margin-top:16px;">
                    <label for="description">Internal Description</label>
                    <textarea name="description" id="description"><?php echo e(old('description', $service->description)); ?></textarea>
                </div>
                <div class="form-group" style="margin-top:16px;">
                    <label for="website_description">Website Description</label>
                    <textarea name="website_description" id="website_description"><?php echo e(old('website_description', $service->website_description)); ?></textarea>
                ...
                <div class="form-grid-3">
                    <div class="form-group">
                        ...
                        <input type="number" name="default_price" id="default_price"
                               value="<?php echo e(old('default_price', $service->default_price)); ?>" min="0" step="0.01" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="cost_price" id="cost_price"
                               value="<?php echo e(old('cost_price', $service->cost_price)); ?>" min="0" step="0.01">
                    </div>
                    <div class="form-group">
                        <label for="vat_rate">VAT Rate (%)</label>
                        <input type="number" name="vat_rate" id="vat_rate"
                               value="<?php echo e(old('vat_rate', $service->vat_rate)); ?>" min="0" max="100" step="0.01">
                    </div>
                    <div class="form-group">
                        ...
                        <input type="number" name="estimated_duration_minutes" id="estimated_duration_minutes"
                               value="<?php echo e(old('estimated_duration_minutes', $service->estimated_duration_minutes)); ?>" min="0" step="15">
                    </div>
                    <div class="form-group">
                        <label for="sort_order">Sort Order</label>
                        <input type="number" name="sort_order" id="sort_order"
                               value="<?php echo e(old('sort_order', $service->sort_order ?? 0)); ?>" min="0">
                ...
                <div class="toggle-row">
                    ...
                    <div class="toggle-group">
                        <input type="checkbox" name="requires_booking" id="requires_booking" value="1"
                               <?php echo e(old('requires_booking', $service->requires_booking) ? 'checked' : ''); ?>>
                        <div>
                            <label for="requires_booking">Requires Booking</label>
                            <div class="hint">Customers must book in advance</div>
                        </div>
                    </div>
                    <div class="toggle-group" style="border: 2px solid <?php echo e($service->is_approved ? '#17a2b8' : '#ffc107'); ?>;">
                        <input type="checkbox" name="is_approved" id="is_approved" value="1"
                               <?php echo e(old('is_approved', $service->is_approved) ? 'checked' : ''); ?>>
                        <div>
                            <label for="is_approved">✅ Approved</label>
                            <div class="hint">Required before showing on website</div>
                        </div>
                    </div>
                    <div class="toggle-group" style="border: 2px solid <?php echo e(($service->show_on_website && $service->is_approved && $service->is_active) ? '#fd7e14' : '#ddd'); ?>;">
                        <input type="checkbox" name="show_on_website" id="show_on_website" value="1"
                               <?php echo e(old('show_on_website', $service->show_on_website) ? 'checked' : ''); ?>>
                        <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\doyen\doyen\resources\views\admin\services\edit.blade.php ENDPATH**/ ?>