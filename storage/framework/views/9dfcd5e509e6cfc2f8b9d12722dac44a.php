...
<div class="wrapper">
  ...
  <div class="body">
    <div class="alert">
      <strong>Action Required:</strong> The customer linked to Quote <strong>#<?php echo e($quote->quote_number); ?></strong>
    ...
    <div class="detail-grid">
      <div>
        ...
        <div class="section-value"><?php echo e($quote->quote_number); ?></div>
      </div>
      <div>
        <div class="section-label">Customer</div>
        <div class="section-value"><?php echo e($quote->customer->name ?? 'N/A'); ?></div>
      </div>
      <div>
        <div class="section-label">Customer Email</div>
        <div class="section-value" style="font-size:13px;"><?php echo e($quote->customer->email ?? 'N/A'); ?></div>
      </div>
      <div>
        <div class="section-label">Customer Phone</div>
        <div class="section-value"><?php echo e($quote->customer->phone ?? 'N/A'); ?></div>
      </div>
      <?php if($quote->appointment): ?>
      <div>
        <div class="section-label">Original Date</div>
        <div class="section-value"><?php echo e(\Carbon\Carbon::parse($quote->appointment->scheduled_date)->format('D, j M Y')); ?></div>
      </div>
      <div>
        <div class="section-label">Booking Reference</div>
        <div class="section-value"><?php echo e($quote->appointment->reference_number); ?></div>
      </div>
      <?php endif; ?>
      <div>
        <div class="section-label">Suggested Date</div>
        <div class="section-value" style="color:#1d4ed8;"><?php echo e(\Carbon\Carbon::parse($suggestedDate)->format('D, j M Y')); ?></div>
      </div>
      <div>
        <div class="section-label">Suggested Time</div>
        <div class="section-value" style="color:#1d4ed8;"><?php echo e($suggestedTime); ?></div>
      </div>
    </div>
    ...
    <?php if($quote->appointment): ?>
    <a href="<?php echo e(config('app.url')); ?>/bookings/<?php echo e($quote->appointment->id); ?>" class="btn">View Booking</a>
    <?php endif; ?>
  </div>
  <div class="footer">
    <p><?php echo e(config('app.garage_name', 'Doyen Auto Services')); ?> — Admin Notification</p>
  </div>
</div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\doyen\doyen\resources\views\emails\admin\quote-date-suggestion.blade.php ENDPATH**/ ?>